(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.engineComfy": { zh: "本地工作流", en: "Local workflow" },
        ...
        "smart.comfyMode": { zh: "本地工作流模式", en: "Local workflow mode" },
        "smart.upscaleTarget": { zh: "超分目标", en: "Upscale Target" },
        "smart.workflow": { zh: "工作流", en: "Workflow" },
        "smart.noWorkflow": { zh: "本地工作流功能已移除", en: "Local workflow support has been removed" },
        ...
        "smart.errNeedWorkflow": { zh: "本地工作流功能已移除", en: "Local workflow support has been removed" },
        "smart.errComfyNoImages": { zh: "本地工作流没有返回图片", en: "Local workflow returned no images" },
        "smart.errComfyEmpty": { zh: "本地工作流返回图片为空", en: "Local workflow returned empty images" },
        ...
        "smart.shortcutBoxSelect": { zh: "空白处拖拽框选节点", en: "Drag on empty canvas to box-select nodes" },
        "smart.shortcutGroup": { zh: "合并选中的节点为组", en: "Group selected nodes" },
        ...
        "smart.shortcutPan": { zh: "按住空格拖动画布", en: "Hold Space and drag to pan the canvas" },
